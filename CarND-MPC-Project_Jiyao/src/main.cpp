      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          auto ptsx_car = Eigen::VectorXd(num_points);
          auto ptsy_car = Eigen::VectorXd(num_points);

          // Convert waypoints to vehicle framework
          ...
          // predict the state after delay and use it as
