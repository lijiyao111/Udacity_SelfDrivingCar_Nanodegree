...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    kernel_initializer_weight = tf.random_normal_initializer(stddev=0.01)
    kernel_regularizer_weight = tf.contrib.layers.l2_regularizer(1e-3)
    # TODO: Implement function
    ...
    conv_1x1_l7 = tf.layers.conv2d(
        ...
        1,  # kernel_size
        padding='same',
        kernel_initializer=kernel_initializer_weight,
        kernel_regularizer=kernel_regularizer_weight,
        name='conv_1x1_l7')
    # Upsample deconvolution x 2
    l7_up = tf.layers.conv2d_transpose(
        conv_1x1_l7,
        num_classes,
        4,  # kernel_size
        strides=(2, 2),
    ...
    conv_1x1_l4 = tf.layers.conv2d(
        ...
        name='conv_1x1_l4')
    # Adding skip layer.
    l4_skip = tf.add(l7_up, conv_1x1_l4, name='l4_skip')
    # Upsample deconvolutions x 2.
    l4_up = tf.layers.conv2d_transpose(
        l4_skip,
        num_classes,
        4,  # kernel_size
        strides=(2, 2),
    ...
    conv_1x1_l3 = tf.layers.conv2d(
        ...
        name='conv_1x1_l3')
    # Adding skip layer.
    l3_skip = tf.add(l4_up, conv_1x1_l3, name='l3_skip')
    # Upsample deconvolution x 8.
    l3_up = tf.layers.conv2d_transpose(
        l3_skip,
        num_classes,
        16,
        strides=(8, 8),
...
def train_nn(sess, epochs, batch_size, get_batches_fn, train_op,
    ...
    for epoch in range(epochs):
        ...
        for image, label in get_batches_fn(batch_size):
            ...
            loss_batch.append('{:3f}'.format(loss))
        print(loss_batch)
        print()
