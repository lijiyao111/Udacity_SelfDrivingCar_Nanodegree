...
UKF::UKF() {
  ...
  */
  ...
  weights_ = VectorXd::Constant(2*n_aug_ + 1, 0.5/(n_aug_+lambda_));
...
void UKF::UpdateState(const VectorXd& z, const VectorXd& z_pred,
...
void UKF::UpdateLidar(MeasurementPackage measurement_pack) {
  ...
  */
  ...
  PredictLidarMeasurement(z_pred_lidar, Zsig_lidar, S_lidar);
  UpdateState(measurement_pack.raw_measurements_, z_pred_lidar,
	      Zsig_lidar, S_lidar);
...
void UKF::UpdateRadar(MeasurementPackage measurement_pack) {
  ...
  */
  ...
  PredictRadarMeasurement(z_pred_radar, Zsig_radar, S_radar);
  UpdateState(measurement_pack.raw_measurements_, z_pred_radar,
	      Zsig_radar, S_radar);
